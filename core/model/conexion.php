<?php
    ...
    class Conexion
    {
        ...
        private $db_bachillerato = 'db_bachillerato';
        private $db_primaria = 'db_primaria';


        # Funcion que permite conectarnos a la base de datos
        public function conectarbachillerato()
        {
            # Creamos un objeto de conexion MySQLI
            $this->mysqli = new mysqli($this->server, $this->usuario, $this->clave, $this->db_bachillerato);
        ...
        # Funcion que permite conectarnos a la base de datos
        public function conectarprimaria()
        {
            # Creamos un objeto de conexion MySQLI
            $this->mysqli = new mysqli($this->server, $this->usuario, $this->clave, $this->db_primaria);
        ...
        public function liberar($consulta){
          ...
          return mysqli_free_result($this->mysqli->query($consulta));
        }
